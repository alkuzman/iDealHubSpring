...
public class BadgeController {
    ...
    public BaseEntityIterable<Badge> init() {
        ...
        badge1.setMinimumCoverage(0.75);
        ...
        badge2.setMaximumCoverage(0.75);
        badge2.setMinimumCoverage(0.50);
        ...
        badge3.setMaximumCoverage(0.5);
        badge3.setMinimumCoverage(0.25);
        ...
        badge.setMinimumSnackPeakQuality(1.25);
        badges.add(badge);
        ...
        badge_1.setMaximumSnackPeakQuality(1.25);
